...
- with **New episodes** turned on, up to sixty-four notifications the operating system holds on Cue's behalf: one for each show you are watching on each day a new episode of it is out, or, with **Daily summary instead** on, one each morning naming what airs that day. Cue builds them on the device from the calendar and the Up Next list it has already read and hands them to the OS, which holds them and shows them on your lock screen. Nothing about them is sent anywhere, and neither is the list of shows you have muted. Turning the switch off cancels all of them, signing out also forgets the mutes, and on Android your phone asks for permission to post notifications the first time you turn the switch on.

...
import { REPOSITORY_ROOT } from "../support/repository-path";

const MANIFESTS = ["package.json", "packages/core/package.json", "packages/native/package.json"];
 ...
 * `react` that a package peer satisfies is enough to give the app renderer a
 * different React instance than its component library, which
